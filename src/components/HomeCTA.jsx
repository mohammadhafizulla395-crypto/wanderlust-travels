      ...
      <div className="max-w-[1320px] mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          >
            <Link
              to="/booking"
              className="inline-flex items-center justify-center bg-white text-neutral-900 hover:bg-primary-50 font-semibold px-8 py-4 rounded-lg transition-all duration-300 text-base"
            >
              Start Planning
            </Link>
            ...
            <a
              href={generateWhatsAppUrl(
                'Hello! I would like to plan a trip with Wanderlust Travels.'
              )}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center gap-2 border-2 border-white/30 hover:border-white text-white font-semibold px-8 py-4 rounded-lg transition-all duration-300 text-base"
            >
