    ...
    <section className="relative py-24 md:py-32 overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-[1400px] px-5 md:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          >
            <h2 className="font-heading text-3xl md:text-4xl lg:text-5xl font-bold text-white leading-[1.15] mb-5">
              Ready to Plan
              <br />
              Your Adventure?
            </h2>
            <p className="text-white/60 text-base md:text-lg leading-relaxed mb-10">
              Let us craft the perfect journey for you. Tell us where you want to go.
            </p>
