    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-end overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 pb-8 md:pb-12">
          ...
          >
            <span className="inline-block text-xs font-medium text-white bg-secondary-700 px-3 py-1 rounded-lg mb-4">
              {post.category}
            </span>
          ...
          <div className="max-w-3xl mx-auto">
            ...
            >
              {post.content.map((paragraph, i) => {
                const isHeading = i > 0 && i % 3 === 0
                if (isHeading) {
                  return (
                    <h2 key={i} className="font-heading text-2xl font-bold text-neutral-900 mt-12 mb-4">
                      {paragraph.split('.')[0]}
                    </h2>
                  )
                }
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="mt-12 bg-gradient-to-br from-primary-50 to-primary-100 rounded-2xl p-8"
            >
            ...
            {related.length > 0 && (
              ...
              >
                <h3 className="font-heading text-2xl font-bold mb-8">Continue Reading</h3>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                  {related.map((r) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        <h4 className="font-heading font-semibold text-sm text-neutral-900 group-hover:text-primary-600 transition-colors line-clamp-2">
                          {r.title}
                        </h4>
                        <span className="text-xs text-neutral-400 mt-1 block">{r.date}</span>
                      </div>
                    </Link>
                  ))}
                </div>
