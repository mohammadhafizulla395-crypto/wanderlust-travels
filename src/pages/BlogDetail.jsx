...
export default function BlogDetail() {
  ...
  return (
    <div>
      {/* Hero */}
      <section className="relative h-[50vh] md:h-[60vh] min-h-[320px] flex items-end overflow-hidden">
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8 relative z-10 pb-8 md:pb-12">
          <Breadcrumbs items={[
            { label: 'Blog', to: '/blog' },
            { label: post.title },
          ]} />
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="mt-12 bg-gradient-to-br from-primary-50 to-primary-100 rounded-xl p-8 border border-primary-100"
            >
