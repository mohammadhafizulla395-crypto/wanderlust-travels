  ...
  if (!post) {
    return (
      <div className="py-32 text-center">
        ...
        <Link to="/blog" className="text-primary-500 hover:underline font-medium">
          Browse all articles
        </Link>
      </div>
    )
    ...
    <div>
      ...
      <section className="relative h-[50vh] min-h-[350px] flex items-end overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 pb-8 md:pb-12">
          ...
          >
            <span className="inline-block text-xs font-medium text-white bg-forest-700 px-3 py-1 rounded-lg mb-4">
              {post.category}
            </span>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto">
            ...
            <motion.div
              ...
              className="flex items-center gap-3 mb-10 pb-6 border-b border-stone-200"
            >
              ...
              <a
                ...
                className="w-9 h-9 rounded-lg bg-stone-100 hover:bg-primary-50 text-stone-600 hover:text-primary-500 flex items-center justify-center transition-colors"
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.5 }}
              className="mt-12 bg-forest-50 rounded-2xl p-8 border border-forest-100"
            >
              <h3 className="font-heading text-xl font-bold text-charcoal mb-4">Key Takeaways</h3>
              <ul className="space-y-3">
                {post.content.slice(0, 3).map((p, i) => (
                  <li key={i} className="flex items-start gap-3">
                    ...
                    <span className="text-stone-600 text-sm leading-relaxed">{p.slice(0, 120)}...</span>
                  </li>
                ))}
              </ul>
            </motion.div>
        ...
        <section className="bg-ivory-soft py-16">
          <div className="container mx-auto px-4">
            <motion.div
              ...
              transition={{ duration: 0.5 }}
            >
              <h2 className="font-heading text-2xl font-bold text-charcoal mb-8">Continue Reading</h2>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                {related.map((r) => (
                  ...
                  >
                    ...
                    <div className="p-5">
                      <span className="text-xs text-stone-400 mb-1 block">{r.date}</span>
                      <h4 className="font-heading font-semibold text-sm text-charcoal group-hover:text-primary-500 transition-colors line-clamp-2">
                        {r.title}
                      </h4>
                    </div>
                  </Link>
