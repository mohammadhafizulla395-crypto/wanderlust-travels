...
export default function Reviews() {
  ...
  return (
    <div>
      ...
      <section className="py-20 md:py-28 bg-ivory">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <p className="text-[#184638] font-semibold text-sm tracking-[0.2em] uppercase mb-3">
                Testimonials
              </p>
              <h1 className="font-heading text-4xl md:text-5xl lg:text-6xl font-bold text-charcoal mb-4 leading-[1.1]">
                Traveler Reviews
              </h1>
      ...
      {/* Stats Bar */}
      <section className="py-12 bg-ivory border-y border-stone-100">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-0">
            {[
              ...
              <motion.div
                ...
                className="flex items-center gap-8 md:px-12"
              >
                <div className="text-center md:border-r md:border-stone-200 md:pr-12">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <div className="relative">
              <div className="absolute -top-4 left-1/2 -translate-x-1/2 text-primary-500/20 text-[120px] font-heading leading-none select-none pointer-events-none">
                "
              </div>
              <div className="relative z-10 pt-8">
                <div className="flex items-center justify-center gap-1 mb-6">
                  {[...Array(5)].map((_, j) => (
                    <svg key={j} className="w-5 h-5 text-primary-500" fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                <p className="font-heading text-xl md:text-2xl italic text-stone-700 leading-relaxed mb-8">
                  "{reviews[0].text}"
                </p>
                <div className="flex items-center justify-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-ivory flex items-center justify-center text-charcoal font-bold flex-shrink-0">
                    {reviews[0].name.split(' ').map(n => n[0]).join('')}
                  </div>
                  <div className="text-left">
                    <div className="font-semibold text-charcoal">{reviews[0].name}</div>
                    <div className="text-sm text-stone-500">{reviews[0].tour} · {reviews[0].destination}</div>
                  </div>
                </div>
              </div>
            </div>
            ...
            {reviews.slice(1).map((review, i) => (
              ...
              >
                <div className="flex items-center gap-0.5 mb-4">
                  {[...Array(5)].map((_, j) => (
                    <svg key={j} className={`w-4 h-4 ${j < review.rating ? 'text-primary-500' : 'text-stone-200'}`} fill="currentColor" viewBox="0 0 20 20">
                      <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                    </svg>
                  ))}
                </div>
                ...
                <div className="flex items-center gap-3 pt-4 border-t border-stone-100">
                  <div className="w-10 h-10 rounded-full bg-ivory flex items-center justify-center text-charcoal font-semibold text-sm flex-shrink-0">
                    {review.name.split(' ').map(n => n[0]).join('')}
                  </div>
                  <div>
                    <div className="font-medium text-sm text-charcoal">{review.name}</div>
                    <div className="text-xs text-stone-400">{review.tour} · {review.destination}</div>
                  </div>
                </div>
              </motion.div>
            ))}
      ...
      <section className="py-16 md:py-24 bg-ivory">
        <div className="container mx-auto px-4">
          ...
          >
            <p className="text-[#184638] font-semibold text-sm tracking-[0.2em] uppercase mb-3">Why Travelers Trust Us</p>
            <h2 className="font-heading text-3xl md:text-4xl font-bold text-charcoal mb-4">Why Travelers Trust Us</h2>
          </motion.div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {[
              ...
              >
                <div className="mb-4 text-charcoal flex justify-center">
                  {item.icon}
                </div>
