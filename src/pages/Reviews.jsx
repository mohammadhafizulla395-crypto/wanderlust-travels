    ...
    <div>
      ...
      <section className="py-20 md:py-28 bg-white">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              <p className="text-secondary-600 font-semibold text-sm tracking-[0.2em] uppercase mb-3">Testimonials</p>
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          ...
          >
            <div className="text-primary-200 text-8xl font-heading leading-none select-none mb-6">"</div>
            <p className="font-heading text-xl md:text-2xl italic text-neutral-700 leading-relaxed mb-8">
              {reviews[0].text}
            </p>
            ...
            <div className="flex items-center justify-center gap-4">
              <div className="w-12 h-12 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-700 font-bold flex-shrink-0">
            ...
            {reviews.slice(1).map((review, i) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-full bg-neutral-100 flex items-center justify-center text-neutral-700 font-semibold text-sm flex-shrink-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <motion.div
                ...
                className="bg-white rounded-2xl p-6"
              >
                <div className="text-neutral-900 mb-4">{item.icon}</div>
