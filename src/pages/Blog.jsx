        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          >
            <Link
              ...
              className="group grid grid-cols-1 lg:grid-cols-2 gap-8 bg-white rounded-xl overflow-hidden hover:shadow-xl transition-all duration-500"
            >
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          {filtered.length === 0 && (
            <div className="text-center py-16">
              ...
              <p className="text-neutral-500 mb-4">No articles found in this category.</p>
              <button
