    ...
    <div>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
            ...
            <motion.div
              ...
              className="lg:col-span-6"
            >
              <p className="text-terracotta font-semibold text-xs tracking-[0.2em] uppercase mb-3">
                Our Story
              </p>
              <h2 className="font-heading text-3xl md:text-4xl font-bold text-charcoal mb-6">
                A Passion for Meaningful Travel
              </h2>
              <div className="space-y-4 text-charcoal/70 leading-relaxed">
                <p>
                  ...
                  travel enthusiasts in Kochi has grown into a trusted travel company
              ...
              <div className="mt-8 flex items-center gap-4">
                <div className="bg-forest text-white rounded-xl px-5 py-3 text-center">
                  <div className="text-2xl font-bold">8+</div>
                  <div className="text-xs text-white/70">Years</div>
                </div>
                <div className="text-charcoal/60 text-sm leading-relaxed">
                  Crafting unforgettable journeys across India since 2015
                </div>
              </div>
            </motion.div>
          </div>
      ...
      <section className="py-16 md:py-24 bg-ivory">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          >
            <p className="text-terracotta font-semibold text-xs tracking-[0.2em] uppercase mb-2">
              Purpose
            </p>
            ...
            {[
              {
                ...
                title: 'Our Mission',
                desc: 'To make incredible travel experiences accessible to everyone, while preserving the natural beauty and cultural heritage of every destination we serve.',
              },
              {
                icon: (
                  <svg className="w-8 h-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                title: 'Our Vision',
                desc: "To be India's most trusted travel company, known for creating meaningful and sustainable travel experiences that enrich lives.",
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.5, delay: i * 0.1 }}
                className="bg-ivory rounded-xl p-8 border border-charcoal/5"
              >
                <div className="w-16 h-16 rounded-xl bg-forest/10 text-forest flex items-center justify-center mb-5">
                  {item.icon}
                </div>
                <h3 className="font-heading text-xl font-semibold text-charcoal mb-3">{item.title}</h3>
            ...
            {[
              {
                ...
                title: 'Authenticity',
                desc: 'Every experience is genuine, designed to immerse you in local culture and traditions.',
              },
              {
                icon: (
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                desc: 'We partner with eco-conscious providers and minimize our environmental footprint.',
              },
              {
                icon: (
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                title: 'Community',
                desc: 'We support local communities by sourcing locally and hiring local guides.',
              },
              {
                icon: (
                  <svg className="w-7 h-7" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                title: 'Quality',
                desc: 'Handpicked accommodations, verified guides, and meticulous attention to detail.',
              },
            ].map((item, i) => (
              <motion.div
                key={item.title}
                ...
                className="bg-white rounded-xl p-6 border border-charcoal/5 hover:shadow-md transition-shadow duration-300"
              >
                <div className="w-14 h-14 rounded-xl bg-terracotta/10 text-terracotta flex items-center justify-center mb-4">
                  {item.icon}
                </div>
            ...
            >
              <div className="aspect-[4/5] rounded-xl overflow-hidden shadow-xl">
                <img
                  ...
                  alt="Group of travelers enjoying a journey"
                  className="w-full h-full object-cover"
                  loading="lazy"
                />
              </div>
              ...
              {[
                {
                  ...
                  desc: 'Knowledgeable guides who bring destinations to life with stories and insights.',
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  desc: 'No hidden costs. What you see is what you pay, with flexible payment options.',
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  title: 'Safety First',
                  desc: 'Verified accommodations, insured vehicles, and 24/7 support during your trip.',
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  desc: 'Every trip is tailored to your preferences, pace, and budget.',
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  title: '24/7 Support',
                  desc: 'Our team is always just a call or message away throughout your journey.',
                },
                {
                  icon: (
                    <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <motion.div
                  ...
                  className="flex items-start gap-4 bg-white rounded-xl p-5 border border-charcoal/5"
                >
                  <div className="w-10 h-10 rounded-lg bg-forest/10 text-forest flex items-center justify-center flex-shrink-0 mt-0.5">
                    {item.icon}
                  </div>
                  <div>
