...
export default function About() {
  ...
  return (
    <div>
      ...
      {/* Stats */}
      <section className="py-20 md:py-28 bg-secondary-500">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
            ...
            {timeline.map((item, i) => (
              ...
              >
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-primary-500 text-white flex items-center justify-center font-bold text-sm flex-shrink-0">
                    {item.year}
                  </div>
                  {i < timeline.length - 1 && (
                    <div className="w-px flex-1 bg-primary-500/30 mt-2" />
                  )}
                </div>
                <div className="pb-8">
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              >
                <div className="w-16 h-16 rounded-lg bg-primary-50 text-primary-500 flex items-center justify-center mb-5">
                  {item.icon}
                </div>
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {values.map((item, i) => (
              ...
              >
                <div className="w-14 h-14 rounded-lg bg-primary-50 text-primary-500 flex items-center justify-center mx-auto mb-4">
                  {item.icon}
                </div>
