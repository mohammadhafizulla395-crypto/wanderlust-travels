      ...
      <section className="py-16 md:py-24 bg-[#FCFAF6]">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-2 md:grid-cols-12 gap-3 md:gap-4">
            {filtered.map((item, i) => {
              const isLarge = i % 5 === 0
              const spanClass = isLarge ? 'col-span-2 md:col-span-5' : 'col-span-1 md:col-span-4'
              const aspectClass = isLarge ? 'aspect-[3/4]' : 'aspect-square'
              ...
              return (
                <motion.button
                  ...
                  className={`group relative ${spanClass} ${aspectClass} rounded-2xl overflow-hidden bg-stone-100 cursor-pointer`}
                >
                  <img
                    src={item.image}
                    alt={item.title}
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            className="text-center mt-8 text-sm text-stone-400"
          >
