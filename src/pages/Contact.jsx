              ...
              <div className="bg-white rounded-2xl p-8 md:p-10 shadow-lg">
                ...
                <div className="flex flex-col sm:flex-row gap-3 mb-8">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center justify-center gap-2 bg-green-600 hover:bg-green-700 text-white font-semibold px-6 py-3 rounded-lg transition-colors duration-200"
                  >
                  ...
                  <a
                    href="tel:+919100527275"
                    className="inline-flex items-center justify-center gap-2 border border-neutral-200 text-neutral-700 font-semibold px-6 py-3 rounded-lg hover:bg-neutral-100 transition-colors duration-200"
                  >
                    Call Us
                  </a>
                </div>
                ...
                {submitted ? (
                  <div className="text-center py-8">
                    <h3 className="font-heading text-xl font-semibold mb-2 text-neutral-900">WhatsApp Opening...</h3>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      <div>
                        ...
                        <input
                          ...
                          className={`w-full bg-neutral-50 border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${errors.name ? 'border-red-400' : 'border-neutral-200'}`}
                      ...
                      <div>
                        ...
                        <input
                          ...
                          value={form.email}
                          onChange={handleChange}
                          className={`w-full bg-neutral-50 border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all ${errors.email ? 'border-red-400' : 'border-neutral-200'}`}
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        value={form.message}
                        onChange={handleChange}
                        className={`w-full bg-neutral-50 border rounded-lg px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all resize-none ${errors.message ? 'border-red-400' : 'border-neutral-200'}`}
                    ...
                    <button
                      type="submit"
                      className="bg-primary-500 hover:bg-primary-600 text-white font-semibold px-8 py-3 rounded-lg transition-colors duration-200"
                    >
                      Send Message
                    </button>
                  </form>
