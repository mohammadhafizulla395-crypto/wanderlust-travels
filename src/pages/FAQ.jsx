      ...
      <section className="py-20 md:py-28">
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          <motion.div
            ...
            className="mb-10"
          >
            <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide -mx-6 px-6 md:mx-0 md:px-0 md:flex-wrap md:justify-center">
                  ...
                  return (
                    <motion.div
                      ...
                      className={`bg-white rounded-xl overflow-hidden transition-all duration-200 ${
                        isOpen ? 'shadow-lg ring-1 ring-secondary-200' : 'shadow-sm'
                      }`}
                    >
                      <button
                        onClick={() => toggle(globalIndex)}
                        onKeyDown={(e) => handleKeyDown(e, globalIndex)}
                        className="w-full text-left px-6 py-5 flex items-center justify-between hover:bg-neutral-50/50 transition-colors"
        ...
        <div className="max-w-[1320px] mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center bg-primary-600 hover:bg-primary-700 text-white font-semibold px-8 py-4 rounded-lg transition-colors duration-300"
              >
                Contact Us
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-primary-200 text-primary-700 font-semibold px-8 py-4 rounded-lg hover:bg-primary-50 transition-all duration-300"
              >
