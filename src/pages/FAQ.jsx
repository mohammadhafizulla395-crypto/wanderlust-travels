                  ...
                  return (
                    <motion.div
                      ...
                      className={`border rounded-xl overflow-hidden transition-colors duration-200 ${
                        isOpen ? 'border-primary-200 bg-primary-50/30' : 'border-neutral-200'
                      }`}
                    >
                      <button
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                to="/contact"
                className="inline-flex items-center justify-center bg-primary-600 hover:bg-primary-700 text-white font-semibold px-8 py-4 rounded-full transition-colors duration-300"
              >
                Contact Us
              </Link>
              <a
                ...
                className="inline-flex items-center justify-center gap-2 border-2 border-primary-200 text-primary-700 font-semibold px-8 py-4 rounded-full hover:bg-primary-50 transition-all duration-300"
              >
